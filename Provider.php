...
{
    public const IDENTIFIER = 'IXBTAUTH';
    ...
    {
        return $this->buildAuthUrlFromBase($this->getIxbtAuthUrl('authorize_uri'), $state);
    }
    ...
    {
        return $this->getIxbtAuthUrl('token_uri');
    }
    ...
    {
        $response = $this->getHttpClient()->get($this->getIxbtAuthUrl('userinfo_uri'), [
    ...
    protected function getIxbtAuthUrl($type)
    {
